class CaseInformation:
    ...
    'application_to_MCL_7003311': 'application'"", 
    'is already in the courts possession': 'y/n', 
    'isare offered for probate and': 'y/n', 
    'undefined': "", 
...
'Name of applicant': {}, 
'Relationship to decedent ie heir devisee child spouse creditor beneficiary etc': {'/T': 'Relationship to decedent ie heir devisee child spouse creditor beneficiary etc', 
'/FT': '/Tx', '/TU': 'Relationship to decedent, i.e., heir, devisee, child, spouse, creditor, beneficiary, etc', '/Ff': 8388608}, 
'Date of death': {'/T': 'Date of death', '/FT': '/Tx', '/TU': 'Date 
of death', '/Ff': 8388608}, 
'Time if known': {'/T': 'Time if known', '/FT': '/Tx', '/TU': 'Time (if known', '/Ff': 8388608}, 
'CityTownshipVillage': {'/T': 'CityTownshipVillage', '/FT': '/Tx', '/TU': 'City/Township/Village', '/Ff': 8388608}, 
'County': {'/T': 'County', '/FT': '/Tx', '/TU': 'County', '/Ff': 8388608}, 
'State': {'/T': 'State', '/FT': '/Tx', '/TU': 'State', '/Ff': 8388608}, 
'A death certificate has been issued and a copy accompanies this application as a separate document': {'/T': 'A death certificate has been issued and a copy accompanies this application as a separate document', '/FT': '/Btn', '/TU': 'A death certificate has been issued, and a copy accompanies this application as a separate document'}, 
